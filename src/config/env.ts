...
const envSchema = z.object({
  ...
  ENGINE_OFFLINE_ROUTING_ENABLED: z.string().optional(),
...
export const env = {
  ...
  ENGINE_BACKGROUND_WORKERS_ENABLED:
    parsed.data.ENGINE_BACKGROUND_WORKERS_ENABLED !== undefined
      ...
      : false,
  ENGINE_OFFLINE_ROUTING_ENABLED:
    parsed.data.ENGINE_OFFLINE_ROUTING_ENABLED !== undefined
      ? parsed.data.ENGINE_OFFLINE_ROUTING_ENABLED === 'true'
      : false,
