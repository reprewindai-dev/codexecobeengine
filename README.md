...
- Deploy this repo as the private `ecobe-engine` Railway service.
- Use [`railway.json`](/Users/antho/.windsurf/ecobe-engineclaude/ecobe-engine/railway.json) at repo root.
- Keep public networking disabled when possible.
- Pair it with the public `ecobe-mvp` service documented in [C:\Users\antho\.windsurf\ecobe-mvp\docs\RAILWAY_PRODUCTION_DEPLOYMENT.md](C:\Users\antho\.windsurf\ecobe-mvp\docs\RAILWAY_PRODUCTION_DEPLOYMENT.md).
